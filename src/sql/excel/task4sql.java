        ...
        while (!"8".equals(s)) {
            ...
            switch (x) {
                ...
                case 3 -> {
                    ...
                    statement3.setString(2, str1.substring(8, 12));
                    i++;
                    statement3.setInt(3, i);
                    statement3.setString(4, str2.substring(4, 6));
                ...
                case 4 -> {
                    ...
                    statement4.setString(2, str1.toLowerCase());
                    i++;
                    statement4.setInt(1, i);
                    statement4.setString(2, str2.toUpperCase());
                ...
                case 5 -> {
                    ...
                    String dop_str_in = in.nextLine();
                    System.out.println(str1.contains(dop_str_in));

                    statement5.setInt(1, i);
                    statement5.setBoolean(2, str1.contains(dop_str_in));
                    statement5.executeUpdate();
                    i++;

                    System.out.println("Введите строку для поиска конца: ");
                    String dop_str_end = in.nextLine();
                    System.out.println(str2.endsWith(dop_str_end));
